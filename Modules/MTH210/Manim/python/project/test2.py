...
#=====================s \in [-2,-1]
    ...
    def curve_function__2__1(s,t,f = ini_curve__2__1):
        ...
        x = s+f(s)*t
        y = t
        z = (-(2*x*t+4*t+1)+np.sqrt((2*x*t+4*t+1)*(2*x*t+4*t+1)+(2*x*t+4*t)*(2*x*t+4*t)))/(2*t*t)
        return np.array([x, y, z])
...
#=====================s \in [-1,1]
    ...
    def curve_function__1_1(s,t,f = ini_curve__1_1):
        ...
        return np.array([x, y, z])
    domain__1_1 = (-1,1,t_left,t_right)
#=====================s \in [-1,1]
    def ini_curve__1_1(x):
        return 2-x*x
    def curve_function__1_1(s,t,f = ini_curve__1_1):
...
#======================曲线打包
    curves = (curve_function__inf_2,curve_function__2__1,curve_function__1_1,curve_function_1_2,curve_function_2_inf)
    domains = (domain__inf__2,domain__2__1,domain__1_1,domain_1_2,domain_2_inf)
#======================================================创建动画
    def construct(self,curves = curves,domains = domains):
        ...
        self.wait(3)
#======================================================添加曲线    
    def add_curve(self,curve_function,domain,resolution_fa = 48 ,checkerboard_colors = ['#29ABCA', '#236B8E']):
        curve = Surface(
            curve_function,
